...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      | GUI  | Alt  |SPACE |LOWER |RAISE |Space | Alt  | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,   KC_QUOT, KC_EQL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
      _______,  _______,  _______,  KC_LGUI,  KC_LALT, KC_SPC,  LOWER,  RAISE,   KC_SPC,  KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = KEYMAP( \
      ...
      _______, _______, _______,   _______, _______, _______,                   _______, KC_MINS, KC_UNDS, KC_LCBR, KC_RCBR, KC_BSLS, \
      _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_PIPE, \
